<?php include_once('primer5111header.inc.php') ?>

<h1>Forma za izmenu putovanja</h1>

<?php require_once("primer5108kompanija_meni.inc.php"); ?>

<?php
if (!empty($_GET['id'])) {
    echo "Menjamo putovanje ID={$_GET['id']}";

require_once("../primer5110config.inc.php");
...
<fieldset style="width: 500px">
    <form name="update_trip" id="update_trip" method="post" action="primer5114update_trip.php">
